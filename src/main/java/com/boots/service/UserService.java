...
public class UserService implements UserDetailsService {
    ...
    public Cargo findCargoById(Long cargoId) {
        Optional<Cargo> userFromDb = cargoRepository.findById(cargoId);
        return userFromDb.orElse(new Cargo());
    }
    ...
    public List<Cargo> cargoList(Long idMin) {
        return em.createQuery("SELECT u FROM User u WHERE u.id > :paramId", Cargo.class)
                .setParameter("paramId", idMin).getResultList();
    }
